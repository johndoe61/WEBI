...
module WI_Input = struct
  include Unspec(MW)(WIT)(T)(D)(C)(S)(W)
...
module WEBI_Init_Interp = MakeInterpreter(WI_Input)(Client_interpreter.CL_Interp)(Device_interpreter.DV_Interp)(Server_interpreter.SR_Interp)(Webi_interpreter.WEBI_Interp)(Types_interpreter.T_Interp)
